...
def get_model_data():
    ...
    return {
        ...
        "real_robot": RobotModelConfig(
            urdf_path=REAL_ROBOT_MODELS_DIR / "real_robot.urdf",
            srdf_path=REAL_ROBOT_MODELS_DIR / "real_robot.srdf",
            yaml_config_path=REAL_ROBOT_MODELS_DIR / "real_robot_config.yaml",
